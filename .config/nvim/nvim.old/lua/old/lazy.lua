...
if not (vim.uv or vim.loop).fs_stat(lazypath) then
    local lazyrepo = "https://github.com/folke/nvim.git"
...
require("lazy").setup({
    ...
    -- Harpoon - fast switching between files
    {
    ...
    -- LazyDev - something something lsp
    {
    ...
    { -- Autocompletion
        ...
        opts = {
            keymap = {
                ...
                ['<C-Space>'] = { function(cmp) cmp.show_documentation() end },
